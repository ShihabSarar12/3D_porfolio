      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="text-center mb-16">
            ...
            <h2 className="mb-4 text-white">Projects & Open Source</h2>
            <p className="text-white max-w-2xl mx-auto">
              Building tools and libraries that developers love to use
            </p>
          </div>
        ...
        <div className="relative z-10 p-8 space-y-6">
          ...
          <div className="space-y-2">
            {project.storyBehindIt && (
              <div className="px-4 py-2 rounded-lg bg-white/10 backdrop-blur-md border border-white/20 text-white font-medium">
                The Story Behind It
              </div>
            )}
          ...
          <div className="flex flex-wrap gap-3 pt-6 border-t border-white/10">
            ...
            <a
              ...
              className="ml-auto px-4 py-2 rounded-lg bg-white/10 hover:bg-white/20 text-white font-medium transition-all"
            >
              View Details
            </a>
          </div>
