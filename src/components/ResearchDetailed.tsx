                    ...
                    <div className='flex-1'>
                        <div className='flex items-start justify-between mb-2 flex-wrap gap-2'>
                            <div className='flex items-center gap-2 flex-wrap'>
                                <span className='inline-block px-3 py-1 rounded-full bg-white/10 border border-white/20 text-white'>
                                    {paper.type}
                                </span>
...
function ExpandableSection({
    ...
    return (
        <div className='rounded-lg bg-white/10 backdrop-blur-md border border-white/20 overflow-hidden transition-all'>
            <button
                onClick={onToggle}
                className='w-full flex items-center justify-between p-4 hover:bg-white/10 transition-colors text-white'
            >
                <span>{title}</span>
                {isExpanded ? (
